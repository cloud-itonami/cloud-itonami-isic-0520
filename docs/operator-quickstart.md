# Operator Quickstart — Lignite Mining Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0520** (`cloud-itonami-isic-0520`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0520.git
cd cloud-itonami-isic-0520
```
...
- Blueprint governor key: `lignite-mining-governor`
- Likely source path: `ligniteops.governor.cljc`
